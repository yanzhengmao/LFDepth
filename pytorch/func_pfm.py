...
if __name__ == '__main__':
    data = read_pfm('/home/yzm/flow_sence_datatset/additional/boardgames/gt_disp_lowres.pfm')
    data = data/np.max(data)
    # im = Image.fromarray(data*255.0)
    # data = np.expand_dims(data, axis=-1)
    # im.show()
    # path = '/home/yzm/project/TransDepth-main/pytorch/dataset/kitti_dataset/2011_09_26_drive_0001_sync/proj_depth/groundtruth/image_02/0000000009.png'
    # im = Image.open(path)
    # im = np.array(im)
    # print(im)