...
from epi3 import BtsModel, test, pad_2_full_size, label2disp, prob2disp
from lr_scheduler import build_scheduler
# from bts_dataloader_5 import *
from bts_3epi_dataloader import *
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    epi_loss = get_loss()
    epi_output_loss = get_output_loss()
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            img = torch.stack([traindata_batch_0d, traindata_batch_90d, traindata_batch_45d, traindata_batch_m45d], dim=2)
            ...
            # loss = epi_loss(output, pred_list, tra_hot_annotation)
            output = model(img, args.att_rank)
            loss = epi_output_loss(output,  tra_hot_annotation)
    ...
    for scene in scene_name:
        ...
        for step, eval_sample_batched in enumerate(tqdm(dataloader_test.data)):
            with torch.no_grad():
                ...
                img = torch.stack([valdata_batch_0d, valdata_batch_90d, valdata_batch_45d, valdata_batch_m45d], dim=2)
